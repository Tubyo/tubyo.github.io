...
GUIDE_ORDER=['pip','adblock','chromecast','background','fullscreen','kids','library','sites','platforms']
GUIDE_SECTION={'fr':'Guides pratiques','en':'Practical guides','es':'Guías prácticas','de':'Praktische Anleitungen','nl':'Praktische gidsen'}
GUIDE_CARD={
 'fr':{'pip':'Image dans l’image','adblock':'Filtrage publicitaire','chromecast':'Chromecast','background':'Lecture en arrière-plan','fullscreen':'Plein écran','kids':'Mode enfant','library':'Bibliothèque de créateurs','sites':'Tous vos sites vidéo','platforms':'Android, iPhone, iPad'},
 'en':{'pip':'Picture in Picture','adblock':'Ad filtering','chromecast':'Chromecast','background':'Background playback','fullscreen':'Full screen','kids':'Child mode','library':'Creator library','sites':'All your video sites','platforms':'Android, iPhone, iPad'},
 'es':{'pip':'Imagen dentro de imagen','adblock':'Filtrado de anuncios','chromecast':'Chromecast','background':'Reproducción en segundo plano','fullscreen':'Pantalla completa','kids':'Modo infantil','library':'Biblioteca de creadores','sites':'Todos los sitios de vídeo','platforms':'Android, iPhone, iPad'},
 'de':{'pip':'Bild-in-Bild','adblock':'Werbefilter','chromecast':'Chromecast','background':'Hintergrundwiedergabe','fullscreen':'Vollbild','kids':'Kindermodus','library':'Creator-Mediathek','sites':'Alle Videoseiten','platforms':'Android, iPhone, iPad'},
 'nl':{'pip':'Beeld-in-beeld','adblock':'Advertentiefilter','chromecast':'Chromecast','background':'Achtergrondafspelen','fullscreen':'Volledig scherm','kids':'Kindermodus','library':'Makersbibliotheek','sites':'Alle videosites','platforms':'Android, iPhone, iPad'},
}
def locale_url(lang):
