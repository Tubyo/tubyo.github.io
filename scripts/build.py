...
GUIDE_ORDER=['pip','adblock','chromecast','background','fullscreen','live','kids','library','save','shortcuts','sites','private','platforms']
GUIDE_SECTION={'fr':'Guides pratiques','en':'Practical guides','es':'Guías prácticas','de':'Praktische Anleitungen','nl':'Praktische gidsen'}
GUIDE_CARD={
 'fr':{'pip':'Image dans l’image','adblock':'Filtrage publicitaire','chromecast':'Chromecast','background':'Lecture en arrière-plan','fullscreen':'Plein écran','live':'Vidéos en direct','kids':'Mode enfant','library':'Bibliothèque de créateurs','save':'Sauvegarder une vidéo','shortcuts':'Raccourcis de sites','sites':'Tous vos sites vidéo','private':'Navigation privée','platforms':'Android, iPhone, iPad'},
 'en':{'pip':'Picture in Picture','adblock':'Ad filtering','chromecast':'Chromecast','background':'Background playback','fullscreen':'Full screen','live':'Live video','kids':'Child mode','library':'Creator library','save':'Save a video','shortcuts':'Site shortcuts','sites':'All your video sites','private':'Private browsing','platforms':'Android, iPhone, iPad'},
 'es':{'pip':'Imagen dentro de imagen','adblock':'Filtrado de anuncios','chromecast':'Chromecast','background':'Reproducción en segundo plano','fullscreen':'Pantalla completa','live':'Vídeo en directo','kids':'Modo infantil','library':'Biblioteca de creadores','save':'Guardar un vídeo','shortcuts':'Atajos de sitios','sites':'Todos los sitios de vídeo','private':'Navegación privada','platforms':'Android, iPhone, iPad'},
 'de':{'pip':'Bild-in-Bild','adblock':'Werbefilter','chromecast':'Chromecast','background':'Hintergrundwiedergabe','fullscreen':'Vollbild','live':'Livestreams','kids':'Kindermodus','library':'Creator-Mediathek','save':'Video speichern','shortcuts':'Seitenverknüpfungen','sites':'Alle Videoseiten','private':'Privates Surfen','platforms':'Android, iPhone, iPad'},
 'nl':{'pip':'Beeld-in-beeld','adblock':'Advertentiefilter','chromecast':'Chromecast','background':'Achtergrondafspelen','fullscreen':'Volledig scherm','live':'Livestreams','kids':'Kindermodus','library':'Makersbibliotheek','save':'Video bewaren','shortcuts':'Snelkoppelingen','sites':'Alle videosites','private':'Privébrowsen','platforms':'Android, iPhone, iPad'},
}
def locale_url(lang):
